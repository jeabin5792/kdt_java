...
public class callbyreference {
	public static void main(String[] args) {
		...
		//참조값과 call by value
		int[] ar = {1,2,3};
		System.out.println("매소드 호출 전 : " + ar[0]);
		System.out.println(ar);
//		modifyArray(ar);
//		System.out.println("매소드 호출 후 : " + ar[0]);
		
		System.out.println("array2 메소드 호출 전 : "+ ar[0]);
		modifyArray2(ar);
		System.out.println("array2메소드 호출 후 : "+ ar[0]);
	}
	...
	//배열의 참조값이 복사되어 전달되므로 메소드 내부에서 배열의 값을 변결하면 원본배열에도 영향을 미친다
