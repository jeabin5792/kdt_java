...
public class MapTest02 {
	public static void main(String[] args) {
		...
		//삭제 remove
//		System.out.println(coffee.remove("캬라멜마끼아또")); //해당하는 value값 반환되고 삭제
		System.out.println(coffee.remove("캬라멜마끼아또",3000)); //boolean타입으로 삭제 성공여부 반환하고 삭제
		System.out.println(coffee);
