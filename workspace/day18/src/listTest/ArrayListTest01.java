...
//		al2.add(0.6);
		...
		//삭제 메소드 : index번호로 삭제하고 요소를 반환(int)
		System.out.println("인덱스 1의 값 : "+al.remove(1) + "을 삭제했습니다");
		System.out.println("인덱스 1의 값 : "+al2.remove(1) + "을 삭제했습니다");
		System.out.println(al2);
		
		//삭제 : 값으로 검색하여 삭제(Object), 삭제 성공여부를 반환 .remove(Object)
